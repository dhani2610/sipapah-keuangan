    ...
    <div class="row">
      ...
      <div class="content-wrapper">
        ...
        <div class="news-card">
          ...
          <img src="{{ asset('assets/img/foto_kegiatan/'.$item->foto_kegiatan) }}" alt="" class="news-card__image">
          ...
          <div class="news-card__text-wrapper">
            <h2 class="news-card__title">{{ $item->nama_kegiatan }}</h2>
            <div class="news-card__post-date">Jan 29, 2018</div>
            <div class="news-card__details-wrapper">
              <p class="news-card__excerpt">            <p class="mb-4 d-block">{{ Illuminate\Support\Str::limit($item->deskripsi_kegiatan, 100) }}</p></p>
